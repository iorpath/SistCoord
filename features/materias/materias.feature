Feature: Administer Courses
 ...
 so I have the master courses information always up-to-date 
 
   Scenario: I sign in, enter to option "Materias", enter to option "Crear materia", and I create the master program
